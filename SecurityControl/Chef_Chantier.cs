...
{
    public partial class Chef_Chantier : Form
    {
        ...
        public void RichTextBox()
        {
            ...
            if (nv_Danger.Checked)
            {
                richTextBox_alerte.Text = "DANGER";
                richTextBox_alerte.ForeColor = Color.Red;
            }
            if (nv_OK.Checked)
            {
                richTextBox_alerte.Text = "OK";
                richTextBox_alerte.ForeColor = Color.Green;
            }
            if (nv_Vigilance.Checked)
            {
                richTextBox_alerte.Text = "VIGILANCE";
                richTextBox_alerte.ForeColor = Color.Orange;
            }
        ...
        private void FixerAlerte()
        {
            ...
            string Message = richTextBox_Affichage.Text;            
        ...
        private void AfficherAlerte()
        {
            ...
            try
            {
                ...
                string sql = "INSERT INTO alertes_meteo (NiveauAlerte, Temperature, Humidite, CO2, MessageAlerte, Vent) VALUES (@NiveauAlerte, @Temperature, @Humidite, @CO2, @AlerteMessage, @Vent)";
                MySqlCommand cmd = new MySqlCommand(sql, connection);
                cmd.Parameters.AddWithValue("@NiveauAlerte", richTextBox_alerte.Text);
                cmd.Parameters.AddWithValue("@Temperature", temp);
                cmd.Parameters.AddWithValue("@Humidite", hum);
                cmd.Parameters.AddWithValue("@CO2", co2);
                cmd.Parameters.AddWithValue("@Vent", label_vent.Text);
                cmd.Parameters.AddWithValue("@AlerteMessage", Message);
